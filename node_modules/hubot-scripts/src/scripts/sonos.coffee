...
#
# Commands:
#   hubot sonos playing - show what's playing on the office Sonos
...
playing = (msg) ->
    console?.log "what is playing on sonos..."
    body = """
